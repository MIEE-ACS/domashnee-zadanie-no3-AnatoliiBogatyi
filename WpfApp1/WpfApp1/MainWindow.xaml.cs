...
namespace WpfApp1
{
    public partial class MainWindow : Window
    {
        ...
        public int x = rand.Next(1, 9);
        public int y = rand.Next(1, 9);
        ...
        private void startBtn_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            mainMenu.Background = new LinearGradientBrush(Colors.LightBlue, Colors.AliceBlue, 90);
        ...
        private void checkBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                counterOfFalseAns++;
                tb_countOfFalseAns.Text = $"{counterOfFalseAns}";
                label_correct.Content = "Ты ошибся!";
